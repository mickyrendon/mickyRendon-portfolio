export const modalSpanish = [
    {
        title: `¡Atención!`,
        p: `Serás redirigido a una pagina de 'reCAPTCHA' para verificar que no erés spam.`,
        cancelBtn: `Cancelar`,
        sendBtn: `Aceptar`,
        ok:`OK`,
        // atention modal
...
export const modalEnglish = [
    {
        title: `¡Atention!`,
        p: `You will be redirected to a 'reCAPTCHA' page to comprobate you're not spam.`,
        cancelBtn: `Cancel`,
        sendBtn: `Accept`,
        ok:`OK`,
        // atention modal
